...
#set( $symbol_dollar = '$' )
#set( $symbol_escape = '\' )
package ${package}.${secondModule}.camel;
...
@Component
public class ${secondModule}RouteBuilder extends RouteBuilder {

    static final String ROUTE_ID_TODO = "route." + APP_NAME + ".${secondModule}.fromTodo";
    ...
    @Autowired
    public ${secondModule}RouteBuilder(
    ...
    public void configure() {
        ...
        from("timer:${secondModule}?period=" + fromTimerPeriod).routeId(ROUTE_ID_TODO)
